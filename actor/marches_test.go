...
func TestMarchesStruct(t *testing.T) {
	marches := newMarches()
	marches.set(march{Uid: 1, MarchId: 1, At: 3, Op: "startMarch"})
	marches.set(march{Uid: 2, MarchId: 2, At: 2, Op: "startMarch"})
	marches.set(march{Uid: 2, MarchId: 2, At: 8, Op: "recall"})
